...
void ex_1()
{
	...
	cout << "Ñðåäíåå àðèô., äîáàâëåííîå â êîíåö:\n";
	show_lst(lst);
	...
	cout << "Óäàëåííûå ýëåìåíòû èç çàäàííîãî äèàïîçîíà:\n";
	show_lst(lst);
	...
	cout << "Äîáàâèòü ìàêñ. è ìèí. ê êàæäîìó ýëåìåíòó:\n";
	show_lst(lst);
}
//================
...
//================
// èíà÷å íå çàïóøèòü pair â priority_queue
