...
public:
	...
	Iterator<T> begin() { return Iterator<T>(head); }	// âîçâðàùàåò óêàçàòåëü íà ïåðâûé ýëåìåíò
	Iterator<T> end() { return Iterator<T>(top->next); }// âîâçðàùàåò óêàçàåòëü íà ïîñëåäíèé ýëåìåíò
